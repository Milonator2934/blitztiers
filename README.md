...
Signup uses Supabase email OTP verification. In the Supabase dashboard, update the email template so users receive the six digit code directly:
...
Also set the Supabase Site URL to `https://blitztiers.com` and add any preview URLs you use as allowed redirect URLs.
